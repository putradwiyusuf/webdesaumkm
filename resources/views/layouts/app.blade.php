  ...
  <div class="wrapper">
    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
      ...
      <a href="#" class="brand-link">
        ...
        <span class="brand-text font-weight-light">UMKM Wargaluyu</span>
      </a>
      ...
      <div class="sidebar">
        ...
        <div class="user-panel mt-3 pb-3 mb-3 d-flex">
          ...
          <div class="info">
            <p class="d-block text-danger">{{ Auth::user()->name; }}</p>
            <a href="#" class="d-block text-primary">{{ Auth::user()->email; }}</a>
          </div>
        </div>
    ...
    <footer class="main-footer">
      ...
      <!-- Default to the left -->
      <strong>Copyright &copy; {{ date('Y') }} <a href="https://kmsitcomputer.com/">KMSIT Computer</a>.</strong> All rights reserved.
    </footer>
  </div>
  <!-- ./wrapper -->
